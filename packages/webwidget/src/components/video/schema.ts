...
export const VIDEO_WIDGET_SETTINGS_SCHEMA: InspectorSchema = [
    {
        key: 'videoUrl',
        label: '视频地址',
        type: 'string',
    ...
    },
    {
        ...
        page: 'widget',
        order: 200,
        bind: 'props.posterUrl',
        meta: { placeholder: '可选：输入 poster URL' },
    },
    {
        key: 'objectFit',
        label: '裁切方式',
