...
] satisfies WidgetSettingsSchema<{ text: string; fontSize: number; align: string; color: string; font: string }>;
...
describe.skip('WidgetDynamicForm - DISABLED', () => {
    ...
    it('updates editor field value in draft change flow', () => {
        ...
        ] satisfies WidgetSettingsSchema<{ html: string }>;
        ...
        act(() => {
            const valueSetter = Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype, 'value')?.set;
            valueSetter?.call(editor, '<p>changed</p>');
