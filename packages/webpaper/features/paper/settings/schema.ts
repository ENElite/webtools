...
const PAPER_SHARED_SETTINGS_SCHEMA: InspectorSchema = [
    ...
    },
    {
        ...
        label: '不息屏',
        type: 'switch',
        bind: 'enableWakeLock' as BindPath,
        page: 'shared',
        order: 2,
    },
    {
    ...
    },
    {
        ...
        label: '跟踪强度',
        type: 'number',
        bind: 'trackIntensity' as BindPath,
        page: 'shared',
        order: 5,
    ...
    },
    {
        ...
        label: '视频播完切换',
        type: 'switch',
        bind: 'videoAutoSwitchOnEnded' as BindPath,
        page: 'shared',
        order: 6,
    },
];
