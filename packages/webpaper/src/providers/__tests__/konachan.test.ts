...
vi.mock('../konachan/api', async () => {
    const actual = await vi.importActual<typeof import('../konachan/api')>('../konachan/api');
    return {
        ...actual,
        fetchKonachan: vi.fn(),
    };
...
import { DEFAULT_KONACHAN_SETTINGS, type KonachanProviderSettings } from '../konachan/settings';
import { KonachanProvider } from '../konachan/provider';
import { fetchKonachan, type KonachanImageInfo } from '../konachan/api';
