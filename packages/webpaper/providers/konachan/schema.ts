...
export const PROVIDER_KONACHAN_SCHEMA: InspectorSchema = [
    {
        ...
        label: 'API 地址',
        type: 'string',
        bind: 'props.baseUrl' as BindPath,
        page: 'konachan',
        order: 0,
    ...
    },
    {
        ...
        label: '图片质量',
        type: 'enum',
        bind: 'props.quality' as BindPath,
        page: 'konachan',
        order: 2,
    ...
    },
    {
        ...
        label: '跳过相同 PID',
        type: 'switch',
        bind: 'props.skipPid' as BindPath,
        page: 'konachan',
        order: 3,
    },
    {
    ...
    },
    {
        ...
        label: '图片宽度',
        type: 'combiner',
        bind: ['props.widthOperator', 'props.widthValue'] as unknown as BindPath,
        page: 'konachan',
        order: 6,
        meta: {
            operatorOptions: [
    ...
    },
    {
        ...
        label: '图片高度',
        type: 'combiner',
        bind: ['props.heightOperator', 'props.heightValue'] as unknown as BindPath,
        page: 'konachan',
        order: 7,
        meta: {
            operatorOptions: [
