 ...
 */
export const PROVIDER_KONACHAN_SCHEMA: SettingsSchema<KonachanProviderSettings> = [
    {
        key: 'baseUrl',
        label: 'API 地址',
        type: 'string',
        placeholder: '/api/konachan',
    },
    {
        key: 'page',
        label: '起始页码',
