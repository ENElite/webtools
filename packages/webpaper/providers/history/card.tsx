...
export function ImageCard({ item, onDetail, onPreview, onSetCurrent }: ImageCardProps) {
    return (
        <article className='group overflow-hidden rounded-2xl border border-slate-300/30 bg-white/90 shadow-[0_18px_32px_rgba(15,23,42,0.08)] transition-[transform,box-shadow] duration-150 ease-out hover:-translate-y-0.5 hover:shadow-[0_22px_40px_rgba(15,23,42,0.12)]'>
